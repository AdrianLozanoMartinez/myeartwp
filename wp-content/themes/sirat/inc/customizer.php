...
function sirat_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'sirat_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/multipurpose-wordpress-theme/">GET PRO</a>','sirat'),
		'panel' => 'sirat_homepage_panel'
	) );
	...
	$wp_customize->add_section( 'sirat_services_section' , array(
    	...
    	'description' => __('For more options of services section <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/multipurpose-wordpress-theme/">GET PRO</a>','sirat'),
		'priority'   => null,
		'panel' => 'sirat_homepage_panel'
	) );
	...
	$wp_customize->add_section('sirat_footer',array(
		...
		'description' => __('For more options of footer section <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/multipurpose-wordpress-theme/">GET PRO</a>','sirat'),
		'panel' => 'sirat_homepage_panel',
	));
