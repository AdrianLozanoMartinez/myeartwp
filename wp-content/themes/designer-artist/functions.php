...
function designer_artist_activation_notice() {
	...
	echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/designer-portfolio-wordpress-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'designer-artist' ) .'</a></span>';
	echo '</div>';
}
...
function designer_artist_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar 3', 'designer-artist' ),
		'description'   => __( 'Appears on page sidebar', 'designer-artist' ),
		'id'            => 'sidebar-3',
		'before_widget' => '<aside id="%1$s" class="widget mb-5 p-3 %2$s">',
		'after_widget'  => '</aside>',
...
define('DESIGNER_ARTIST_FREE_THEME_DOC',__('https://preview.vwthemesdemo.com/docs/free-designer-portfolio/','designer-artist'));
...
define('DESIGNER_ARTIST_BUY_NOW',__('https://www.vwthemes.com/products/designer-portfolio-wordpress-theme/','designer-artist'));
define('DESIGNER_ARTIST_LIVE_DEMO',__('https://www.vwthemes.net/designer-portfolio/','designer-artist'));
define('DESIGNER_ARTIST_PRO_DOC',__('https://preview.vwthemesdemo.com/docs/designer-portfolio-pro/','designer-artist'));
...
define('DESIGNER_ARTIST_CREDIT',__('https://www.vwthemes.com/products/free-artist-wordpress-theme/','designer-artist'));
...
if (!function_exists('designer_artist_edit_link')) :

    function designer_artist_edit_link($view = 'default')
    {
        global $post;
            edit_post_link(
                sprintf(
                    ...
                    /* translators: %s: Name of current post. Only visible to screen readers */
                        __('Edit <span class="screen-reader-text">%s</span>', 'designer-artist'),
                        array(
                            'span' => array(
                                'class' => array(),
                            ),
